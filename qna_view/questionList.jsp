...
<link rel='stylesheet' href='<%=request.getContextPath()%>/css/list.css?ver=3'>
</head>
<body>
<h2>Q&A</h2>
<% String pno=request.getParameter("p_no");%>
<div id ="question_contain">
	<a class='wBTN1' href="<%=request.getContextPath()%>/qna/write.do?p_no=<%=pno %>&pageNo=${questionPage.currentPage}">문의작성</a>
